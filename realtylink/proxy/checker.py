...
"""
The following code is an adapted version of @maxmalysh on Github.
https://github.com/maxmalysh/python-proxy-checker/blob/master/proxy.py
"""
...
def run():
    ...
    class ProcessThread(threading.Thread):
        ...
        def process(self, task):
            ...
            opener.addheaders = [('User-Agent', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.181 Safari/537.36')]
